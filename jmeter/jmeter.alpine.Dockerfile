...
RUN apk update && apk upgrade && apk add curl unzip && \
    ...
    rm -rf /var/lib/apk/* /var/cache/apk/* /tmp/* /var/tmp/*
...
RUN addgroup -g 500 jmeter && adduser --disabled-password --home $JMETER_HOME --ingroup jmeter --uid 500 -G jmeter jmeter
