...
Run from docker-tutorial folder
```
> docker build -t dockertk/nodeserver -f 09-Dockerfile .
> docker run --rm -d dockertk/nodeserver
```
Next create a production like setup to deploy, hence needs certificates
